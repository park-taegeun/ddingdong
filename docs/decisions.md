...
- 도착 예상: 2026-05-26 (화) ~ 2026-05-29 (금), 영업일 3~5일 기준 (5/23 토 발주 → 주말 끼고 영업일 계산)
...
- 22.7 메이크잇펀 도착 5/26~5/29 예상 → PoC 1주차 5/18 진입 자연 슬립
...
- **결정**: **옵션 B (메일 발송 X)** + 옵션 D 연기 (산학협력단 NCP 제휴 추진 메일, 5/18 이후 평일 진입 후 결정)
- **헛수고 회피**: 메일 발송 + 5/18~5/19 거절 답변 회피 (단기 손실 5분, 단기 이득 0)
- **장기 가치**: 옵션 D 진행 시 후배 가치 창출 (학기 끝나기 전 처리 시 OK)
