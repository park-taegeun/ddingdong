...
PoC-(41) **3건** → PR #45 **1건** → PR #47 **2건**. 전부 **위임 작성 시점에 기억으로 절 번호를 박아서** 생긴 오류다.
...
- 🟡 **[신규 미결] "도어벨" 표기 잔존 2건 (발견·문서 반영 2026-09-08 PoC-(42), 근거유형 = 실측 grep)**: `dashboard/src/lib/notification-meta.ts:1`(주석) / **`dashboard/index.html:8`(`<meta name="description">` — 브라우저 탭·검색엔진에 노출되는 사용자 가시 문자열)**. 해소 = 대시보드 소액 PR 소관.
