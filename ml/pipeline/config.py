...
# 순서 = 라벨 인덱스(서버 계약). other 는 33.13(a) D4 · 33.13(d) — 끝에 추가(인덱스 3), 0·1·2 불변.
# --------------------------------------------------------------------------
CLASSES: tuple[str, ...] = ("doorbell", "knock", "fire_alarm", "other")
...
BG_NOISE_SNR_DB: dict[str, tuple[float, ...]] = {
    ...
    #   증강 흔적이 「양성」의 가짜 단서가 된다(33.17(e) pad 원리와 같다).
    "other": (10.0, 20.0),
}
